...
func addOperatorInitFlags(cmd *cobra.Command, args *operatorInitArgs) {
	...
	cmd.PersistentFlags().StringVarP(&args.common.manifestsPath, "charts", "", "", chartsFlagHelpStr)
	cmd.PersistentFlags().StringVarP(&args.common.manifestsPath, "manifests", "d", "", chartsFlagHelpStr)
